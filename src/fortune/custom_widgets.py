...
class SelectTimeWidget(Widget):
    ...
    def __init__(self, attrs=None, hour_step=None, minute_step=None, second_step=None, twelve_hr=False):
        ...
        super(SelectTimeWidget, self).__init__()
...
# class DateTimeSelectWidget(MultiWidget):
class SplitSelectDateTimeWidgetA(MultiWidget):
    """
    ...
    def __init__(self, attrs=None, hour_step=None, minute_step=None, second_step=None, twelve_hr=None, years=None):
        ...
        widgets = (SelectDateWidget(attrs=attrs, years=years),
                   SelectTimeWidget(attrs=attrs, hour_step=hour_step, minute_step=minute_step,
                                    second_step=second_step, twelve_hr=twelve_hr))
        super(SplitSelectDateTimeWidgetA, self).__init__(widgets, attrs)
...
class SplitSelectDateTimeWidgetB(MultiWidget):
    """
    MultiWidget = A widget that is composed of multiple widgets.
    ...
    def __init__(self, attrs=None, hour_step=None, minute_step=None, second_step=None, twelve_hr=None, years=None):
        ...
        super(SplitSelectDateTimeWidgetB, self).__init__(widgets, attrs)
