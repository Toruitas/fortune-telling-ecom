...
from .models import MEMBERSHIP_LEVELS, MyProfile
...
YEARS = tuple(range(1900, this_year+1))
...
try:
    class ProfileFieldsForm(forms.ModelForm):
        ...
        date_of_birth = forms.DateField(required=True, label=_("Enter your birthday"), widget=SelectDateWidget(years=YEARS))
        direction_1 = forms.ChoiceField(label=_("What direction does your primary location face?"),
                                        required=True, choices=[("n", _("North")),
                                                                ("nw", _("Northwest")),
                                                                ("w", _("West")),
                                                                ("sw", _("Southwest")),
                                                                ("s", _("South")),
        ...
        direction_2 = forms.ChoiceField(label=_("What direction does your secondary location face?"),
                                        required=False, choices=[("n", _("North")),
                                                                 ("nw", _("Northwest")),
                                                                 ("w", _("West")),
                                                                 ("sw", _("Southwest")),
                                                                 ("s", _("South")),
        ...
        direction_3 = forms.ChoiceField(label=_("What direction does your third location face?"),
                                        required=False, choices=[("n", _("North")),
                                                                 ("nw", _("Northwest")),
                                                                 ("w", _("West")),
                                                                 ("sw", _("Southwest")),
...
class ProfileForm(Html5Mixin, forms.ModelForm):
    ...
    """
    first_name = forms.CharField(label=_("Chinese Name"))
    last_name = forms.CharField(label=_("English Name"))
...
#     """
#
#     first_name = forms.CharField(label=_("English Name"))
#     last_name = forms.CharField(label=_("Chinese Name"))
#     password1 = forms.CharField(label=_("Password"),
#                                 widget=forms.PasswordInput(render_value=False))
#     password2 = forms.CharField(label=_("Password (again)"),
#                                 widget=forms.PasswordInput(render_value=False))
...
class MembershipForm(Html5Mixin, forms.Form):
    level = forms.ChoiceField(choices=MEMBERSHIP_LEVELS, widget=forms.RadioSelect())


class ConfirmationForm(Html5Mixin, forms.Form):
    level = forms.CharField(widget=forms.HiddenInput()) # , initial=xxx)
...
class BirthdayForm(forms.ModelForm):
    date_of_birth = forms.DateField(label=_("Enter your birthday"), widget=SelectDateWidget(years=YEARS))
...
class EmailForm(forms.ModelForm):
    ...
    def clean_email2(self):
        # check that 2 password entries match
        email = self.cleaned_data.get('email')
